Name:		storpool-block-dep-18.02.752.1736934
Version:	1
Release:	1%{?dist}
Summary:	Ensure the packages required for the StorPool installation are available
BuildArch:	noarch
Requires:	python, storpool-beacon-dep-18.02.752.1736934, storpool-common-dep-18.02.752.1736934, storpool-config-dep-18.02.752.1736934
