Name:		storpool-repsync-dep-18.02.752.1736934
Version:	1
Release:	1%{?dist}
Summary:	Ensure the packages required for the StorPool installation are available
BuildArch:	noarch
Requires:	binutils, findutils, iputils, kexec-tools, openssh-clients, rsync, storpool-config-dep-18.02.752.1736934, util-linux
