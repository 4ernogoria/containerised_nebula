Name:		storpool-cli-dep-18.02.752.1736934
Version:	1
Release:	1%{?dist}
Summary:	Ensure the packages required for the StorPool installation are available
BuildArch:	noarch
Requires:	perl, perl-Data-Dump, perl-JSON-XS, perl-Term-ReadLine-Gnu, perl-libwww-perl, storpool-config-dep-18.02.752.1736934
